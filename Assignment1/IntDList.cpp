...
// ******Used for quick testing during development; Program is run and tested with intDList_test.cpp using "g++ -std17=c++17 -Wall IntDList.cpp intDList_test.cpp" in terminal
// int main() {
//     IntDLList myList;
